...
# Function to mutate a word, ensuring it remains a permutation of the available characters
...
# Function to perform crossover between two parents, ensuring valid permutations
...
def genetic_algorithm(target, population_size=100, mutation_rate=0.01, max_generations=1000):
    # Generate the set of available characters including both uppercase and lowercase variants
...
if __name__ == "__main__":
    ...
    target_word = sys.argv[1].lower()  # Ensure the target word is lowercase
    population_size = 50
    mutation_rate = 1
